...
@section('content')
    @include('admin.components.breadcrumb', ['lastTitle' => 'Вакансии'])
    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title">Вакансии</h3>
            <div class="block-options">
                <a href="{{ route('admin.vacancy.create') }}" class="btn btn-alt-primary"><i
            ...
            <div class="table-responsive">
                <table class="table table-stripped table-bordered table-vcenter js-dataTable-full">
                    ...
                    @foreach($data as $vacancy)
                        <tr>
                            <td class="font-w600 text-center">{{ $vacancy->title }}</td>
                            <td class="font-w600 text-center">{{ $vacancy->category->title }}</td>
                            <td class="font-w600 text-center">{{ $vacancy->city }}</td>
