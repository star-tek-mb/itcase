...
@section('title', 'Создать статическую страницу')
...
@section('content')
    ...
    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title">Создать <small>статическую страницу</small></h3>
                    ...
                    <div class="block-content block-content-full tab-content" style="min-height: 265px;">
                        ...
                        <div class="tab-pane active" id="wizard-simple-step1" role="tabpanel">
                            ...
                            <div class="form-group @error('slug.ru') is-invalid @enderror">
                                ...
                                <input class="form-control" type="text" id="ru_slug" name="slug[ru]" value="{{ old('slug.ru') }}">
                        ...
                        <div class="tab-pane" id="wizard-simple-step2" role="tabpanel">
                            ...
                            <div class="form-group @error('slug.en') is-invalid @enderror">
                                ...
                                <input class="form-control" type="text" id="en_slug" name="slug[en]" value="{{ old('slug.en') }}">
                        ...
                        <div class="tab-pane" id="wizard-simple-step3" role="tabpanel">
                            ...
                            <div class="form-group @error('slug.uz') is-invalid @enderror">
                                ...
                                <input class="form-control" type="text" id="uz_slug" name="slug[uz]" value="{{ old('slug.uz') }}">
