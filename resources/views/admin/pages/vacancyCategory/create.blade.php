...
@section('title') Добавить категорию вакансий @endsection
...
@section('content')
    @include('admin.components.breadcrumb', [
        ...
        'lastTitle' => 'Добавить категорию вакансий'
    ])

    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title">Добавить категорию вакансий</h3>
        </div>
        <!-- Form -->
        <form action="{{ route('admin.vacancyCategory.store') }}" method="post" enctype="multipart/form-data">
            @csrf
